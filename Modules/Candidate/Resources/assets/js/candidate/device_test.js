...
var DeviceTestFunction = (function () {
    ...
    function updatedeviceInfo(mic, audio) {
        ...
        else $("#elem_mic").html('<i class="bi bi-x-lg text-danger"></i>');
        ...
        if (camera == "1") {
            ...
            $("#elem_strvideo").html(
                '<div class="border-gray-100 border  py-16 bg-dark bg-opacity-25 d-none d-lg-block"><span class="text-dark fw-bolder d-block text-center">                                                    Camera Not Found</span><span class="text-dark fw-bolder mb-1 fs-3"></span></div>'
            );
        }
