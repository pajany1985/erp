                                ...
                                <div class="row mb-7">
                                    <div class="col-lg-12">
                                        ...
                                        <select name="country"  id="country" data-control="select2"  data-placeholder="Select a Country..." class="form-select" data-allow-clear="true">
                                            ...
                                            <option value='{{ $cntry->country_id}}' @if(isset($employer)) @if ($cntry->country_id == $employer->country_id) selected @endif @endif >{{$cntry->country }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="fv-row">
                                ...
                                <div class="row mb-7">
                                     <div class="col-lg-6">
                                        ...
                                        <input type="text"  id="billing_city" class="form-control" name="billing_city" placeholder="billing_city" value="">
                                    </div>

                                     <div class="col-lg-6">
                                        <label class="required fs-5 fw-bold mb-2" for="billing_zip">Zip
                                           </label>
                                            <input type="text"  id="billing_zip" class="form-control" name="billing_zip" placeholder="billing_zip" value="">
                                    ...
                                    <!--end::Input-->
                                     ...
                                     <div class="col-lg-6">
                                        <label class="required fs-5 fw-bold mb-2" for="exp_date">Expiration Date
                                           ...
                                           <input type="text"  id="exp_date" class="form-control" name="exp_date" placeholder="Expiration Date" value="">
