                ...
                <form class="card-body py-20 w-100 w-xl-700px px-9" method='post' novalidate="novalidate" id="kt_create_account_form" enctype="multipart/form-data"  action="{{ route('register.store') }}">
                    ...
                    <div class="current" data-kt-stepper-element="content">
                        ...
                        <input type="hidden" name="package_id" id="package_id" value="@if(isset($package_id)){{$package_id}}@endif">
                         ...
                         <input type="hidden" name="fromidealapp" id="fromidealapp" value="1">
                         <input type="hidden" name="idealuserid" id="idealuserid" value="{{$idealuserid}}">
                        <!--begin::Wrapper-->
                        <div class="w-100">
                            <!--begin::Heading-->
                                ...
                                <div class="row mb-7">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="first_name"  id="first_name" placeholder="First Name" value="@isset($iappuserdet->first_name){{$iappuserdet->first_name}}@endisset" /> 
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="last_name"  id="last_name" placeholder="Last Name" value="@isset($iappuserdet->last_name){{$iappuserdet->last_name}}@endisset" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" readonly class="form-control" name="email"  id="email" placeholder="Email" value="@isset($iappuserdet->username){{$iappuserdet->username}}@endisset" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row mb-7">
                                     <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="phone"  id="phone" placeholder="Phone Number" value="@isset($iappuserdet->phone_no){{$iappuserdet->phone_no}}@endisset" />
                                        </div>
                                    </div>

                                     <div class="col-lg-6">
                                        <!-- <label class="required  fs-5 fw-bold mb-2" for="password">Password</label>
                                        <input type="password" class="form-control" name="password"  id="password"  required="required" placeholder="Enter Password"/> -->
                                         ...
                                         <div class="mb-10 fv-row" data-kt-password-meter="true">
                                            ...
                                            <div class="mb-1">
                                                <!--begin::Label-->
                                                <label class="required  fs-5 fw-bold mb-2" for="password">Password</label>                                                <!--end::Label-->
                                                <!--begin::Input wrapper-->
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-lg bg-image-none" type="password" name="password" id="password" required="required" placeholder="Enter Password" autocomplete="off" />
                                ...
                                <div class="row mb-7">
                                    <div class="col-lg-12">
                                        ...
                                        <select name="country"  id="country" data-control="select2"  data-placeholder="Select a Country..." class="form-select" data-allow-clear="true">
                                            ...
                                            <option value='{{ $cntry->country_id}}' @if(isset($iappuserdet)) @if ($cntry->country_id == $iappuserdet->country_id) selected @endif @elseif($cntry->country_id == '254') selected @endif >{{$cntry->country }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                 ...
                                 <div class="row mb-7">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="address"  id="address" placeholder="Address" value="@if(isset($iappuserdet->address)){{$iappuserdet->address}}@endif"  /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="city"  id="city" placeholder="City" value="@if(isset($iappuserdet->city)){{$iappuserdet->city}}@endif"  />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="state"  id="state"  data-control="select2"  data-placeholder="Select a State..." class="form-select" data-allow-clear="true">
                                            ...
                                            @foreach($state as $statemst)
                                                <option value='{{ $statemst->state_id}}' @if(isset($iappuserdet)) @if ($statemst->state_id == $iappuserdet->state_id) selected @endif @endif>{{$statemst->state }}</option>
                                            @endforeach 
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="postcode"  id="postcode" placeholder="Postcode" value="@if(isset($iappuserdet->zip)){{$iappuserdet->zip}}@endif" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input type="text" name="company_name" id="company_name" class="form-control form-control-lg " placeholder="Company Name" required value="@if(isset($iappuserdet->business_name)){{$iappuserdet->business_name}}@endif" />
                                </div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input  type="text" name="company_website" id="company_website" class="form-control form-control-lg" placeholder="Eg: http://yoursite.domain" required  value="@if(isset($iappuserdet->business_website)){{$iappuserdet->business_website}}@endif" />
                                </div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                                     ...
                                     <div class="col-lg-6">
                                        <label class="required fs-5 fw-bold mb-2" for="exp_date">Expiration Date
                                          ...
                                          <div class="row fv-row">
                                                                <!--begin::Col-->
                                                                <div class="col-6">
                                                                    <select name="card_exp_month" id="card_exp_month" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Month">
                                                                        <option></option>
