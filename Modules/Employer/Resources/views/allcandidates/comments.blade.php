                    ...
                    <div class="">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="menu menu-column menu-gray-700 menu-state-bg fw-bold menu-active-primary menu-hover-primary " data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item ">
                                    <a href="/employer/candidates/detail/{{$encrypt_cid}}" class="menu-link py-3  emp_position_menulink" data-status="all">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item">
                                <a href="/employer/candidates/commentsactivity/{{$encrypt_cid}}" class="menu-link py-3 active emp_position_menulink" data-status="5">
                                    <span class="menu-icon">
...
@section('scripts')
<script src="{{asset('js/employer/allcandidates/candidateview.js')}}"></script>
