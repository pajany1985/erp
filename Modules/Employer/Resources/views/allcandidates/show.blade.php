             ...
             <!--begin::Title-->
                    <h1 class="d-flex text-gray-800 fw-bolder my-1 fs-4 mb-3">{{ ucfirst($candidate->first_name) }} {{ ucfirst($candidate->last_name) }}</h1>
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 p-1 mx-0">
                                        ...
                                        <li class="breadcrumb-item text-muted"><a href="/employer/candidates" class="text-muted text-hover-primary">Candidates</a></li>
                    ...
                    <div class="">
                        ...
                        <div class="card-body px-0">
                            ...
                            <div class="menu menu-column menu-gray-700 menu-state-bg fw-bold menu-active-primary menu-hover-primary " data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item ">
                                    <a href="/employer/candidates/detail/{{$encrypt_cid}}" class="menu-link py-3 active emp_position_menulink" data-status="all">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item">
                                <a href="/employer/candidates/commentsactivity/{{$encrypt_cid}}" class="menu-link py-3 emp_position_menulink" data-status="5">
                                    <span class="menu-icon">
                            ...
                            <div class="card-toolbar">
                                @if($candidate->status=='3')
                                        <div class="text-hover-primary justify-content-end px-5">
                                            <!-- <a href='javascript:void(0);' data-url="/employer/candidate/downloadzip/cid/{{ encryptId($candidate->id) }}" class="downloadzip text-muted text-hover-primary"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="currentColor"><path d="M0 0h24v24H0z" fill="none"></path><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path></svg></a> -->
                                                                    ...
                                                                    <!-- <div class="card overlay overflow-hidden "  >
                                                                        <div class="card-body p-0">
                                                                            <div class="overlay-wrapper">
                                                                                <video src="{{asset(Config::get('constants.CANDIDVIDEO_STORAGE_PATH')) .'/'.$question['employer_id'].'/'.$question['record_file'] }}"id="upload_videotag{{$key}}" width="240" class="h-210px w-100 d-lg-block" preload="metadata"  style="float:right;">
...
@section('scripts')
<script src="{{asset('js/employer/allcandidates/candidateview.js')}}?version={{rand()}}"></script>
