	...
	<body id="kt_body" class="auth-bg">
		...
		<div class="d-flex flex-column flex-root text-center">
			...
			<div class="d-flex flex-column flex-center flex-column-fluid p-10">
				<!--begin::Illustration-->
				<h1 class="mw-100 mb-10  fs-1 fw-bolder mb-5 color-D6E" >{{$message}}</h1>
				<!--end::Illustration-->
				<!--begin::Message-->
				@if(isset($click_login) && $click_login=='yes')
				<div class="fw-bold fs-3 text-muted mb-15 "><a href="/employer/logout">Click Here to login</a></div>
				@endif
				<!--end::Message-->
				<!--begin::Link-->
