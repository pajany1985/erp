...
var KTDatatablesServerSide = function () {
    ...
    var progressbar = function(){
        ...
        noUiSlider.create(slider,  {start: [minval_value, maxval_value],
        ...
        slider.noUiSlider.on("update", function (values, handle) {
            if (handle) {
                ...
                // var seconds = values[handle] - float_minutes * 60;
    ...
    var handleForm = function(e) {
        ...
        submitButton.addEventListener('click', function (e) {
            ...
            var create_positionallowed = $('#create_positionallowed').val();
        ...
        $('#kt_question_repeater').on('click', '[data-repeater-delete]', function(event) {
            ...
            // Remove the Form validation for Deleted form in Repeater
