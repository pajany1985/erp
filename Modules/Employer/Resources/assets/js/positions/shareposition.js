...
var Share = function () {
    ...
    var sharelink = function(){
        ...
        const target = document.getElementById('link_val');
        const button = document.getElementById('cpy_link');;
    ...
    var shareemail = function() {
           ...
           var tagify = new Tagify(input, {
            ...
            function transformTag(tagData) {
                ...
                // tagData.class = 'tagify__tag tagify__tag--' + states[KTUtil.getRandomInt(0, 3)];
            ...
            submitHandler: function(form) {
                ...
                if(check_tomail!='')
                {
                    ...
                    $.ajax({
                        url:routeurl,
                        type: 'post',
                        data: { "shareemail": shareemail,"link_val": link_val,"positionid":positionid},
                        beforeSend: function(){
