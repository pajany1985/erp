...
var KTSigninGeneral = function() {
                        ...
                        {   
                            ...
                            if(data.code==1)
                            {
                                ...
                                swal.fire({
                                    ...
                                    html:"We've sent <strong>"+capitalize(first_name)+"</strong> an email with a link to finish setting up their user account.<br><br>" +
                                        "Once they've completed this, they will become active and will have full access to the information in your account  ",
                                    type: 'success',
                                    icon: "success",
        ...
        $(document).on("click", ".cfrmdelete", function(e) {
            ...
            if (result.value) {
             $.ajax({
              ...
              url:"subuser/" + userId,
              type:"post",
              data: { '_method': "post",'master_id':master_id },
              dataType:"json",
              success:function(data)
              {
    ...
    var validateAccoutnSetting = function() {
          ...
          rules: {
                ...
                email: {
                    ...
                    remote: {
                        url: "checkemailexist",
                        type: "post",
                        data: { 'id': function() { return $('#authuser').val(); } }
                    },
                        normalizer: function(value) {
                        return $.trim( value );
                    }
