        ...
        validator = FormValidation.formValidation(
            ...
            FormValidation.utils.fetch('settings/checkoldpass', {
                ...
                if (response.valid == false) {
                    validator.updateValidatorOption('oldpassword', 'blank', 'message', 'Old Password is Miss Match')
                    .updateFieldStatus('oldpassword', 'Invalid', 'blank');
...
KTUtil.onDOMContentLoaded(function() {
    ...
    $('#updatepass_close_button').click(function() {
        $('#kt_modal_updatepass_form').trigger("reset");
