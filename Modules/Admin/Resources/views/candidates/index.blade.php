...
@section('pagetitle','Manage Candidates')
@section('content')
<!--begin::Post-->
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-candidate-table-toolbar="base">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <div class="px-7 py-5" data-kt-candidate-table-filter="form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-candidate-table-filter="employer" id="employer" data-hide-search="true">
                                        <option></option>
                                        @foreach ($employers as $key=>$employer)
                                            <option value="{{$employer->id}}">{{ucfirst($employer->first_name)}} {{ucfirst($employer->last_name)}}</option>
                                        @endforeach 
                                    </select>
                                </div>
                                <!--end::Input group-->
                        ...
                        <!--end::Filter-->
                        <!--begin::Export-->
                        <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_export_candidates">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        @can('create candidate')
                            <!--begin::Add candidate-->
                            <button type="button" class="btn btn-primary"  id="btnadd_candidate" >
                            ...
                            <!--end::Svg Icon-->Add candidate</button>
                            <!--end::Add candidate-->
                        @endcan
                    </div>
                    <!--end::Toolbar-->
                    ...
                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-candidate-table-toolbar="selected">
                        ...
                        <button type="button" class="btn btn-danger" id="kt_datatable_delete_all" data-kt-candidate-table-select="delete_selected">Delete Selected</button>
                        @endcan
                    </div>
                    <!--end::Group actions-->
                    <!--begin::Modal - Adjust Balance-->
                    <div class="modal fade" id="kt_modal_export_candidates" tabindex="-1" aria-hidden="true">
                        <!--begin::Modal dialog-->
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Export candidates</h2>
                                    <!--end::Modal title-->
                                      <!--begin::Close-->
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="kt_modal_export_candidates_form" class="form" method="post" action="export-candidates" data-kt-candidates-modal-filter="form">
                                        @csrf
                                        <!--begin::Input group-->
                                        ...
                                        <div class="text-center">
                                            <button type="reset"  data-bs-dismiss="modal" aria-label="Close" class="btn btn-light btn-active-light-primary me-3" id="candidateexport_cancel" data-kt-candidates-modal-action="export_cancel">Discard</button>
                                            <button type="submit" class="btn btn-primary export_submit" data-kt-candidates-modal-action="export_submit">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_candidates">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Candidate Name</th>
                            <th class="min-w-125px">Candidate Email</th>
                            <th class="min-w-125px">Employer Name</th>
                            <th class="min-w-125px">Position</th>
                            <th class="min-w-85px">Used Storage</th> 
...
@section('scripts')
<script src="{{asset('js/admin/candidates/candidates.js')}}"></script>
@endsection