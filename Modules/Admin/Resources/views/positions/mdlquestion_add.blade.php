<div class="modal fade" id="mdlquestion_add" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            ...
            <!--end::Modal header-->
            <!--begin::Form-->
            <form id="kt_modal_add_question_form" method="post" class="form" enctype="multipart/form-data"  action="questions/store">
                <!--begin::Modal body-->
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    @method('POST')
                    @endif
                    <input type="hidden"  id="already_qstn_count" name="already_qstn_count" value="{{$question_count}}">
                    <input type="hidden"  id="max_qtn_allowed" name="max_qtn_allowed" value="{{$max_qtn_allowed}}">
                                            ...
                                            <div class="form-group  fv-row mb-5 border border-hover-primary p-7 rounded">
                                                <div class="row mb-5">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="text" class="form-control" name="question" maxlength="300"  placeholder="Enter Question"   /> 
