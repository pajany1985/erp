    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_create_account_stepper">
            ...
            <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px me-9">
                <div class="card-header border-0 pt-5">					
                    <div class="card-toolbar">
                        <a href="{{route('employers.index')}}" class="btn btn-sm btn-light btn-active-primary" >
                        <!-- svg-icon svg-icon-3 -->
                ...
                <div class="card-body px-6 px-lg-10 px-xxl-15 py-15">
                    ...
                    <div class="stepper-nav">
                        ...
                        <div class="stepper-item" data-kt-stepper-element="nav" data-kt-stepper-action="step">
                            ...
                            <!--begin::Label-->
                            <div class="stepper-label">
                                <h3 class="stepper-title">Packages & Expiry Settings</h3>
                                <div class="stepper-desc fw-bold">Setup Your Packages & Expiry</div>
                            </div>
                            <!--end::Label-->
                        </div>
                        <!--end::Step 4-->
            ...
            <div class="card d-flex flex-row-fluid flex-center">
                ...
                <!--begin::Form-->
                <form class="card-body py-20 w-100 w-xl-700px px-9" method='post' novalidate="novalidate" id="kt_create_account_form" enctype="multipart/form-data"  action="@if(isset($employer))/admin/employers/{{$employer_id}}@else{{ route('employers.store') }}@endif">
                    <!--begin::Step 1-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="state"  id="state"  data-control="select2"  data-placeholder="Select a State..." class="form-select" data-allow-clear="true">
                                            ...
                                            @foreach($state as $statemst)
                                                <option value='{{ $statemst->state_id}}' @if(isset($employer)) @if ($statemst->state_id == $employer->state_id) selected @endif  @endif >{{$statemst->state }} </option>
                                            @endforeach 
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="text" class="form-control" name="postcode"  id="postcode" placeholder="Postcode" value="@if(isset($employer->zip)){{$employer->zip}}@endif" />
                                        </div>
                                    </div>
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="input-group ">
                                    ...
                                    <input  type="text" name="company_website" id="company_website" class="form-control form-control-lg" placeholder="Eg: http://yoursite.domain" required  value="@if(isset($employer->website)){{$employer->website}}@endif" />
                                </div>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row ">
                                ...
                                <!--end::Label-->
                                <!--begin::Image input-->
                                @if(@isset ($employer->company_logo) && $employer->company_logo !="")
                                <div class="image-input image-input-outline" id="kt_image_input_control" data-kt-image-input="true" style="background-image: url({{asset('media/svg/avatars/blank.svg')}})">
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('/uploads/employers/company_logo/'.$employer->company_logo) }});"></div>
                                @else
                    ...
                    <div data-kt-stepper-element="content">
                        ...
                        <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <!--begin::Title-->
                                <h2 class="fw-bolder text-dark">Packages & Expiry Settings</h2>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Input group-->
                            <div class="fv-row">
                                ...
                                <div class="row mb-7">
                                     <div class="col-lg-6">
                                        <label class="required fs-5 fw-bold mb-2" for="package">Package</label>
                                        <input type="hidden" name="existing_packageid" id="existing_packageid" value="@if(isset($employer)){{$employer->package_id}}@endif">
                                        <select name="package" id="package" data-control="select2"  data-placeholder="Select a Package..." class="form-select" data-allow-clear="true">
                                            ...
                                            @foreach ($packages as $key=>$package)
                                                <option value="{{$package->id}}" @if(isset($employer)) @if ($package->id == $employer->package_id) selected @endif @endif>{{ucfirst($package->name)}}</option>
                                            @endforeach  
                                        </select>
                                    </div>

                                     <div class="col-lg-6">
                                        <label class="required fs-5 fw-bold mb-2" for="payment_status">Payment Status</label>
                                        <select name="payment_status" id="payment_status" data-control="select2"  data-placeholder="Select a Payment Status" class="form-select" data-allow-clear="true">
                                            <option></option>
                                            <option value="1" @if(isset($employer)) @if ($employer->payment_status==1) selected @endif @endif>Approved</option>
                                            <option value="2" @if(isset($employer)) @if ($employer->payment_status==2) selected @endif @endif>Pending</option>
                                            <option value="3" @if(isset($employer)) @if ($employer->payment_status==3) selected @endif @endif>Expired</option>
                                            <option value="4" @if(isset($employer)) @if ($employer->payment_status==4) selected @endif @endif>On Hold</option>
                                        </select>
                                    </div>
                                </div>
                                <!--end::Row-->
                            ...
                            <div class="fv-row">
                                ...
                                <div class="row mb-7">
                                     <div class="col-lg-6">
                                        <label class=" fs-5 fw-bold mb-2" for="package">Expiration Date</label>
                                        <div class="mb-10">
                                            <!--begin::Input group-->
                                            <div class="input-group mb-5">
                                            <input class="form-control" placeholder="Pick a date" id="expiration_date" name="expiration_date" value="@if(isset($employer)){{$employer->expire_date}}@endif"/>
                                                <span class="input-group-text datebtn-clear" id="basic-addon2">
                            ...
                            <div class="d-flex flex-stack col-lg-6">
                                <!--begin::Label-->
                                <div class="me-5">
                                    <label class="fs-6 fw-bold form-label">Employer Status</label>
                                </div>
                                <!--end::Label-->
                                <!--begin::Switch-->
                                <input type="hidden" name="status" @if (@isset ($employer->status) && $employer->status == "0") value="0" @else value="1" @endif />
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input check_status"  type="checkbox" @if (@isset ($employer->status) && $employer->status == '0') value="0" @else checked="checked" value="1" @endif name="status_hidden" />
                                </label>
                                <!--end::Switch-->
                            </div>
                            <!--end::Input group-->
...
@section('scripts')
<script src="{{asset('js/admin/employers/addedit.js')}}"></script>
@endsection