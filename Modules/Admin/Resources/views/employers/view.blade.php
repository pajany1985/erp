    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-350px mb-10">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="fw-bolder mb-3">Applied Candidates
                            ...
                            <div class="fw-bolder mb-3">Storage Details</div>
                                <div class="d-flex text-center fw-bolder fs-6 {{$text_color}}">
                                        <span title="{{$used_percentage}}% used" data-bs-toggle="tooltip" data-clipboard1="true"  data-bs-placement="bottom">{{$useddisk_space}} of {{$totalspace}} GB used
                                        </span>
                            </div>   
                             <div class="fw-bolder mt-5">Video Count</div>
                                    <div class="text-gray-600">{{ $videocount}}</div>
                                    <div class="fw-bolder mt-5">Duration</div>
                ...
                @section('scripts')
                <script src="{{asset('js/admin/employers/employerscandidate.js')}}"></script>
                <script src="{{asset('js/admin/employers/employertransaction.js')}}"></script>
                @endsection