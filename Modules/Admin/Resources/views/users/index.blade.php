            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" id="role" data-hide-search="true">
                                        <option></option>
                        ...
                        @can('create users')
                        <!--begin::Add user-->
                        <button type="button" class="btn btn-primary"  id="btnadd_user" >
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="kt_modal_export_users_form" class="form" method="post" action="export-users" data-kt-users-modal-filter="form">
                                        @csrf
                                        <!--begin::Input group-->
                                        ...
                                        <div class="text-center">
                                            <button type="reset"  data-bs-dismiss="modal" aria-label="Close" class="btn btn-light btn-active-light-primary me-3" id="userexport_cancel" data-kt-users-modal-action="export_cancel">Discard</button>
                                            <button type="submit" class="btn btn-primary export_submit" data-kt-users-modal-action="export_submit">
                    ...
                    @include('admin::users.mdl_user')
                    @include('admin::users.mdl_userview')
                    <!--end::Modal - Add task-->
                </div>
                <!--end::Card toolbar-->
            </div>
