...
@section('pagetitle','Question Template')
@section('content')
    <!--begin::Post-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-question-table-toolbar="base">
                        ...
                        <!--end::Export-->
                        @can('create questiontemp')
                        <!--begin::Add question-->
                        <button type="button" class="btn btn-primary"  id="btnadd_questiontemp" >
                    ...
                    <!--end::Group actions-->
                     ...
                     @include('admin::questiontemp.mdl_question')
                     @include('admin::questiontemp.mdlquestion_add')
                    <!--end::Modal - Add task-->
                </div>
                <!--end::Card toolbar-->
            </div>
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_questionstemp">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_questionstemp .form-check-input" value="1" />
                                </div>
                            </th>
...
<script src="{{asset('js/admin/questiontemp/questions.js')}}"></script>
@endsection