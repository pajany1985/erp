...
var KTDatatablesServerSide = function () {
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector('#kt_table_packages');
    ...
    //  Export  functions
        var exportclick = function(){
            const submitButton = document.querySelector('[data-kt-packages-modal-action="export_submit"]');
