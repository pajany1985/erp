...
var KTDatatablesServerSide = function () {
    ...
    var handleSearchDatatable = function () {
        const filterSearch = document.querySelector('[data-kt-position-table-filter="search"]');
    ...
    var handleFilterDatatable = () => {
        ...
        const filterForm = document.querySelector('[data-kt-position-table-filter="form"]');
        const filterButton = filterForm.querySelector('[data-kt-position-table-filter="filter"]');
    ...
    var handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-position-table-filter="reset"]');
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector('#kt_table_positions');
        const checkboxes = container.querySelectorAll('[type="checkbox"]');

        // Select elements
        const deleteSelected = document.querySelector('[data-kt-position-table-select="delete_selected"]');
    ...
    var toggleToolbars = function () {
        // Define variables
        const container = document.querySelector('#kt_table_positions');
        const toolbarBase = document.querySelector('[data-kt-position-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-kt-position-table-toolbar="selected"]');
        // const selectedCount = document.querySelector('[data-kt-position-table-select="selected_count"]');
    ...
    //  Export  functions
        var exportclick = function(){
            const submitButton = document.querySelector('[data-kt-positions-modal-action="export_submit"]');
...
KTUtil.onDOMContentLoaded(function () {
    ...
    $('#close_button').click(function() {
        $('#kt_modal_add_position_form').trigger("reset");
       //$('#mdlposition_add').modal({show:false});
       $('#mdlposition_add').modal('hide');
 
   });

   $('#kt_modal_export_positions').on('show.bs.modal', function () { 
        const filterForm = document.querySelector('[data-kt-positions-modal-filter="form"]');
        const selectOptions = filterForm.querySelectorAll('select');
