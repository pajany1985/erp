        ...
        //    },
           {
            ...
            render: function (data, type, row) {
                var status = {
                    ...
                    3: {'title': 'Expired', 'class': ' badge-light-dark'},
                    4: {'title': 'Rejected', 'class': ' badge-light-danger'},
        ...
        filterButton.addEventListener('click', function () {
            ...
            var storage_percentage = $('#storage_percentage').val();
                ...
                $.ajax({
                    ...
                    type:"post",
                    data: { 'package_search': package_search,'status': status,'payment_status': payment_status,'storage_percentage': storage_percentage },
                    dataType:"json",
