...
/*!********************************************************!*\
  !*** ./Resources/assets/js/allcandidates/candidate.js ***!
  \********************************************************/
 // Class definition
...
var KTDatatablesServerSide = function () {
    ...
    dt = $("#kt_table_candidates").DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          d.positionid = $('#position_id').val(), d.candidatestatus = $('#candidate_status').val(), d.star_rate = $('#star_rating').val(), d.selectedpos = $('#searchpos').select2("val");
        }
      },
      columns: [{
        data: 'id'
  ...
  var handleResetForm = function handleResetForm() {
    ...
    resetButton.addEventListener('click', function () {
      ...
      $('#star_rating').val(''); //$("#searchpos").empty();
