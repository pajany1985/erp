...
/*!**********************************************!*\
  !*** ./Resources/assets/js/positions/add.js ***!
  \**********************************************/
 // Class definition
  ...
  var initValidation = function initValidation() {
    ...
    $("#addmore_question").on("click", function (e) {
      ...
      $(".repeat_items").each(function (index) {
        // console.log(index);
        if (index > 0) {
          validations[1].addField('kt_question_repeater[' + index + '][question]', questionValidators).addField('kt_question_repeater[' + index + '][max_attempts]', maxattemptsValidators).addField('kt_question_repeater[' + index + '][max_minutes]', maxminValidators);
        }
      });
    });
    $('#kt_question_repeater').on('click', '[data-repeater-delete]', function (event) {
      var maxqstn_allowd = $('#max_qtn_allowed').val();
      var index_delete = $(this).closest("[data-repeater-item]").index(); // validations[1].removeField('kt_question_repeater[' + index_delete + '][question]', questionValidators)
      ...
      validations[1].removeField('kt_question_repeater[' + nextlength + '][question]', questionValidators).removeField('kt_question_repeater[' + nextlength + '][max_attempts]', maxattemptsValidators).removeField('kt_question_repeater[' + nextlength + '][max_minutes]', maxminValidators);
