...
/*!**********************************************************!*\
  !*** ./Resources/assets/js/subemployers/subemployers.js ***!
  \**********************************************************/
 // Class definition
    ...
    dt = $("#kt_table_employers").DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          d.package_search = $('#package').val(), d.status = $('#status').val(), d.payment_status = $('#payment_status').val(), d.account_holder = $('#account_holder').val();
        }
      },
      columns: [{
        data: 'id'
