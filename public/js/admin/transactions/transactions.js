...
var KTDatatablesServerSide = function () {
    ...
    dt = $("#kt_table_trans").DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          d.package_search = $('#package').val(), d.status = $('#status').val();
        }
      },
      columns: [{
  ...
  var handleSearchDatatable = function handleSearchDatatable() {
    var filterSearch = document.querySelector('[data-kt-tran-table-filter="search"]');
  ...
  var handleFilterDatatable = function handleFilterDatatable() {
    ...
    var filterForm = document.querySelector('[data-kt-tran-table-filter="form"]');
    var filterButton = filterForm.querySelector('[data-kt-tran-table-filter="filter"]');
  ...
  var handleResetForm = function handleResetForm() {
    // Select reset button
    var resetButton = document.querySelector('[data-kt-tran-table-filter="reset"]'); // Reset datatable
  ...
  var gettranId = function gettranId(e) {
    return e.attr('data-tranid');
  }; //  Export  functions


  var exportclick = function exportclick() {
    var submitButton = document.querySelector('[data-kt-trans-modal-action="export_submit"]');
