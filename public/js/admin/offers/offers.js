...
/*!**********************************************!*\
  !*** ./Resources/assets/js/offers/offers.js ***!
  \**********************************************/
 // Class definition
...
var KTDatatablesServerSide = function () {
    ...
    dt = $("#kt_table_offers").DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          d.status = $('#status').val(), d.package_id = $('#package_id').val();
        }
      },
      columns: [{
        data: 'id'
  ...
  var initToggleToolbar = function initToggleToolbar() {
    ...
    var container = document.querySelector('#kt_table_offers');
  ...
  var toggleToolbars = function toggleToolbars() {
    // Define variables
    var container = document.querySelector('#kt_table_offers');
    var toolbarBase = document.querySelector('[data-kt-offer-table-toolbar="base"]');
    var toolbarSelected = document.querySelector('[data-kt-offer-table-toolbar="selected"]');
    var selectedCount = document.querySelector('[data-kt-offer-table-select="selected_count"]'); // Select refreshed checkbox DOM elements
  ...
  var getofferId = function getofferId(e) {
  ...
  var exportclick = function exportclick() {
    var submitButton = document.querySelector('[data-kt-offers-modal-action="export_submit"]');
