...
var KTDatatablesServerSide = function () {
    ...
    dt = $("#kt_table_users").DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          d.role_search = $('#role').val(), d.status = $('#status').val();
        }
      },
      columns: [{
        data: 'id'
  ...
  var toggleToolbars = function toggleToolbars() {
    ...
    var toolbarSelected = document.querySelector('[data-kt-user-table-toolbar="selected"]'); // const selectedCount = document.querySelector('[data-kt-user-table-select="selected_count"]');
  ...
  var showViewform = function showViewform() {
  ...
  var exportclick = function exportclick() {
    var submitButton = document.querySelector('[data-kt-users-modal-action="export_submit"]');
