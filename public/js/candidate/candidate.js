...
var CandidateFunction = function () {
  ...
  var toContinue = function toContinue() {
    if ($('#first_name').val() != '') {
    ...
    $("#cmsname_form").validate({
      ...
      submitHandler: function submitHandler(form) {
        ...
        var phone_no = $('#phone_no').val(); // $(this).setAttribute('data-kt-indicator', 'on');
    ...
    $(document).on("click", ".tocontinue", function (e) {
      ...
      var encptcandid_id = $(this).attr('data-encptcandid'); // $(this).setAttribute('data-kt-indicator', 'on');
      // $(this).prop("disabled", true);
  ...
  var setQuestionIndex = function setQuestionIndex() {
    $(document).on("click", ".qstndetail", function (e) {
      ...
      var qstn_url = $(this).attr('data-url'); //ajax call 
